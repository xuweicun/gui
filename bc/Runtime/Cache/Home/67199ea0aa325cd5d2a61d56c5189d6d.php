...
<p>已选择品牌：Company:<?php echo ($corpName); ?>/Brand:<?php echo ($brand["name"]); ?>/Category:<?php echo ($category["name"]); ?></p>
<a href="/index.php/Home/Bestforbaby/<?php echo ($action); ?>">重新选择</a>
<div id="layout-container"  style="width:100%;height:auto;">
  ...
  <div id="content" style="display:inline-block;width:70%;height:auto;overflow:hidden;">
    <form method="post" action="/index.php/Home/Bestforbaby/insertitem" name="f1" enctype="multipart/form-data">
