...
<script type="text/javascript" src="/Public/assets/script/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="/Public/assets/script/jquery.nicescroll.js"></script>
<script type="text/javascript" src="/Publicassets/script/lhgdialog/lhgdialog.js?skin=idialog"></script>
<script type="text/javascript" src="/Publicassets/script/layout.js"></script>
<script type="text/javascript">
//页面加载完成时
$(function () {
    //检测IE
    if ('undefined' == typeof(document.body.style.maxHeight)){
        window.location.href = '/isie6';
    }
...
<body class="indexbody">
    ...
    <div class="header">
        <div class="header-box">
            <a href="user/center.r" target="mainframe"><h1 class="logo"></h1></a>
            <ul id="nav" class="nav">
                <li>whatever</li>
            </ul>
            <div class="nav-right">
...
<!--                            <li><a href="--><?//=sa_base_url()?><!--center" target="mainframe">管理中心</a></li>-->
                            ...
                            <li><a id="lbtnExit" href="user/login_page">注销登录</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="main-sidebar">
        <div id="sidebar-nav" class="sidebar-nav">
            <!--<div class="list-box"> before change-->
            <div class="list-box">
            
             <div class="list-group" name="角色">
                    <h2>宝宝用品管理<i></i></h2>
                    <ul>
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a navid="supplier_lists" href="/index.php/Home/bestforbaby/viewitems" target="mainframe" class="item">
                                        <span>查看物品列表</span>
                                    </a>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <a navid="leader_lists" href="/index.php/Home/category/" target="mainframe" class="item">
                                        <span>类别管理</span>
                                    </a>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <a navid="user_lists" href="/index.php/Home/brand/insertitem" target="mainframe" class="item">
                                        <span>增加品牌</span>
                                    </a>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <a navid="admin_add" href="/index.php/Home/company/insertitem" target="mainframe" class="item">
                                        <span>增加厂商</span>
                                    </a>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <a navid="supplier_add" href="<?=sa_base_url();?>role/supplierAdd.r" target="mainframe" class="item">
                                        <span>金牌领队审核</span>
                                    </a>
                                </li>
                            </ul>
    ...
    <div class="main-container">
        <iframe id="mainframe" name="mainframe" frameborder="0" src="/index.php/Home/Bestforbaby"></iframe>
    </div>
