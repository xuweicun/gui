...
<div class="container-fluid content">
    <div class="row">
        ...
        <div class="main">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr ng-repeat="_partition in cab.curr.partitions">
                                                    ...
                                                    <td>{{(_partition.left / 1048576.0).toFixed(2)}} G
													<!--
			...
			<div id="modalAnimNoSN" class="zoom-anim-dialog modal-block modal-block-warning mfp-hide">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">硬盘命令[{{cab.curr.get_commit_cmd_title()}}] -- 无SN号</h4>
                    </div>
                    <div class="panel-body bk-noradius">
                        <div class="modal-wrapper">
                            <div class="modal-icon">
