						...
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
							<div class="tabs tabs-vertical tabs-left">
								<ul class="nav nav-tabs col-sm-3 col-xs-5">
									<li class="active">
										<a data-toggle="tab" href="#pane-level1"><i
												class=" glyphicon glyphicon-align-justify"></i> 第1层</a>
									</li>
									<li ng-repeat="level in levels">
										<a data-toggle="tab" href="#pane-level{{level}}"><i
												class=" glyphicon glyphicon-align-justify"></i> 第{{level}}层</a>
									</li>

								</ul>
								<div class="tab-content">
									<div class="tab-pane active" id="pane-level1">
										<div class="row  bk-padding-10" ng-repeat="group in groups"
											 id="{{level}}-group{{group}}">

											<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" ng-repeat="disk in disks">
												<a class="btn btn-block btn-default" href="#"
												   id="disk-1-{{group}}-{{disk}}"
												   ng-click="selectDisk(1,group,disk);getdiskinfo(1,group,disk,0);"><i
														class=" glyphicon glyphicon-ban-circle"></i> 盘
													#{{group}}-{{disk}}</a>
											</div>
										</div>
									</div>
									<div ng-repeat="level in levels" class="tab-pane" id="pane-level{{level}}">
										<div class="row  bk-padding-10" ng-repeat="group in groups"
											...
											<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" ng-repeat="disk in disks">
												<a class="btn btn-block btn-default" href="#"
												   id="disk-{{level}}-{{group}}-{{disk}}"
												   ng-click="selectDisk(level,group,disk);getdiskinfo(level,group,disk,0);"><i
														class="glyphicon glyphicon-ban-circle"></i> 盘
													#{{group}}-{{disk}}</a>
											</div>
										</div>
								...
								<div class="col-lg-12">
									<div class="panel panel-default bk-bg-white">
										<div class="panel-heading bk-bg-white">
											...
											<div class="panel-actions">
												<a class="btn-minimize" href="/index.php?m=admin&c=business&a=filetree&f={{disk.level}}_{{disk.group}}_{{disk.index}}"><i class="fa fa-list"></i></a>
										...
										<div class="panel-body">
											<div class="table-responsive">
												<table class="table table-bordered">
													...
													<tr>
														<td>位号</td>
														<td>{{disk.level}}-{{disk.group}}-{{disk.index}}<a class="btn" href="#" ng-click="getdiskinfo(disk.level,disk.group,disk.index,1);"><i class="fa fa-refresh"></i></a></td>
													</tr>
													<tr>
														<td>容量</td>
