...
CREATE TABLE `gui_device` (
  ...
  `sn_check_status` smallint(6) DEFAULT NULL COMMENT 'MD5开始前先进行SN查询，现在这个步骤已经取消',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='the storage closet';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gui_disk_md5_log` (
  ...
  `cabinet_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=128 DEFAULT CHARSET=utf8 COMMENT='忠实记录MD5命令执行过程';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gui_disk_smart` (
  ...
  `normal` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=199 DEFAULT CHARSET=utf8 COMMENT='smart value';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gui_disk_smart_log` (
  ...
  `cabinet_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=323 DEFAULT CHARSET=utf8 COMMENT='忠实记录DISKINFO执行过程';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gui_system_run_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1530588 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-07-14 22:48:42
