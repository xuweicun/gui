...
CREATE TABLE `gui_device` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8 COMMENT='the storage closet';
...
CREATE TABLE `gui_disk_md5_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=153 DEFAULT CHARSET=utf8 COMMENT='忠实记录MD5命令执行过程';
...
CREATE TABLE `gui_disk_smart` (
  ...
  `normal` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=utf8 COMMENT='smart value';
...
CREATE TABLE `gui_disk_smart_log` (
  ...
  `cmd_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=336 DEFAULT CHARSET=utf8 COMMENT='忠实记录DISKINFO执行过程';
